...
const PAGE_TITLES = {
  ...
  pageCompanyWallets: { title: 'محافظ الشركة', sub: 'محافظ الإيرادات ومجموعة عناوين الإيداع' },
...
function sendNotification() {
  ...
  toast('success', 'تم الإرسال', 'تم إرسال الإشعار، وسيظهر فعلياً عند المستخدم عبر جرس الإشعارات.');
  renderNotifHistory();
}
...
function saveMaintenance() {
  ...
  toast('success', 'تم الحفظ', cfg.maintenanceMode ? 'تفعّلت شاشة الصيانة فعلياً لكل المستخدمين خلال ثوانٍ.' : 'تم إيقاف وضع الصيانة، عادت المنصة متاحة للمستخدمين.');
}
